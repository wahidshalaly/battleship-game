...
namespace BattleshipGame.UnitTests.Domain.Common
{
    public class ValueObjectTests
    {
        ...
        public void Equals_WhenSameInstance_ReturnsTrue(bool areSame, bool expectedResult)
        {
        ...
        [InlineData(true, true)]
        [InlineData(false, false)]
        public void EqualOperator_WhenSameInstance_ReturnsTrue(bool areSame, bool expectedResult)
        {
            var (subject, subject2) = CreateSubject(areSame);
        ...
        public void NotEqualOperator_WhenSameInstance_ReturnsFalse(
            bool areSame,
            bool expectedResult
        )
        {
