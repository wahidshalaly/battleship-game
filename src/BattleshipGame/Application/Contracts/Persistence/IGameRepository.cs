...
public interface IGameRepository
{
    ...
    Task<Game?> GetByIdAsync(GameId gameId, CancellationToken ct = default);
    ...
    Task DeleteAsync(GameId gameId, CancellationToken ct = default);
    ...
    Task<IReadOnlyCollection<Game>> GetByPlayerIdAsync(PlayerId playerId, CancellationToken ct = default);
    ...
    Task<Game?> GetActiveGameByPlayerIdAsync(PlayerId playerId, CancellationToken ct = default);
}
